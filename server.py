...
class ServerProtocol(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, addr):
        ...
        if datagram == "READY" or datagram == "RETURN":
            ...
            # clear clients set before recieve all data from servers
            self.allClients = set()
        ...
        elif datagram == "QUIT_CLIENT":
            quitText = "QUIT_CLIENT_DATA " + str(addr)
            self.transport.write(quitText.encode("utf-8"), ("228.0.0.1", 9999))
...
class DistributedServerProtocol(DatagramProtocol):
    ...
    def datagramReceived(self, datagram, address):
        ...
        elif datagram.startswith('QUIT_CLIENT_DATA'):
            datagram = datagram[17:]

            self.myClients.discard(eval(datagram))
